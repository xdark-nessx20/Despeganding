...
public class FlightDTOs {
    public record FlightCreateRequest(@NotBlank @Size(min = 3, max = 6) String number, @NotNull OffsetDateTime departureTime,
                                      @NotNull OffsetDateTime arrivalTime, @NotNull Long airline_id,
                                      @NotNull Long origin_airport_id, @NotNull Long destination_airport_id) implements Serializable {}

    public record FlightUpdateRequest(String number, OffsetDateTime departureTime, OffsetDateTime arrivalTime,
                                      Long destination_airport_id) implements Serializable {}
