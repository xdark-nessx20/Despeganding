...
public class BookingDTOs {
    ...
    public record BookingCreateRequest(Long passenger_id) implements Serializable {}
    ...
    public record BookingItemCreateRequest(Long fight_id, String cabin, BigDecimal price, Integer segmentOrder) implements Serializable {}
