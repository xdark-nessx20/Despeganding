...
public class FlightServiceImpl implements FlightService {
    ...
    @Override
    public FlightResponse createFlight(FlightCreateRequest request, Long airline_id,
                                       Long origin_airport_id, Long destination_airport_id) {
    ...
    public FlightResponse updateFlight(FlightUpdateRequest request, Long id, Long destination_airport_id) {
    ...
    @Override @Transactional(readOnly = true)
    public Page<FlightResponse> listScheduledFlights(Long origin_airport_id, Long destination_airport_id,
